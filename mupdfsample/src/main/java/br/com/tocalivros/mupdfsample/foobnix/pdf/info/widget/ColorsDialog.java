package br.com.tocalivros.mupdfsample.foobnix.pdf.info.widget;
...
import br.com.tocalivros.mupdfsample.ui.HSVColorPickerDialog;
import br.com.tocalivros.mupdfsample.ui.HSVColorWheel;
import br.com.tocalivros.mupdfsample.ui.HSVValueSlider;
...
public class ColorsDialog {
    ...
    public ColorsDialog(final FragmentActivity c, final boolean isDayMode, final int colorTextDef, final int colorBgDef, boolean onlyColorBg, final boolean soligBG, final ColorsDialogResult colorsDialogResult) {
        ...
        hsvColorWheel1.setListener(new HSVColorPickerDialog.OnColorSelectedListener() {
            @Override
        ...
        hsvColorWheel2.setListener(new HSVColorPickerDialog.OnColorSelectedListener() {
            @Override
            public void colorSelected(Integer color) {
        ...
        hsvValueSlider1.setListener(new HSVColorPickerDialog.OnColorSelectedListener() {
            @Override
        ...
        hsvValueSlider2.setListener(new HSVColorPickerDialog.OnColorSelectedListener() {
            @Override
            public void colorSelected(final Integer color) {
