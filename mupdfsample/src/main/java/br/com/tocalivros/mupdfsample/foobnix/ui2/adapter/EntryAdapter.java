package br.com.tocalivros.mupdfsample.foobnix.ui2.adapter;
...
import br.com.tocalivros.mupdfsample.foobnix.opds.Entry;
import br.com.tocalivros.mupdfsample.foobnix.opds.Link;
...
import br.com.tocalivros.mupdfsample.foobnix.pdf.info.view.EditTextHelper;
import br.com.tocalivros.mupdfsample.foobnix.pdf.info.view.ScaledImageView;
import br.com.tocalivros.mupdfsample.foobnix.pdf.info.wrapper.AppState;
import br.com.tocalivros.mupdfsample.foobnix.ui2.AppRecycleAdapter;
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holderAll, final int position) {
        ...
        for (final Link link : entry.links) {
            if (link.TYPE_LOGO.equals(link.type) || link.isThumbnail()) {
                ...
                l.addView(search, new LinearLayout.LayoutParams(StaggeredGridLayoutManager.LayoutParams.MATCH_PARENT, StaggeredGridLayoutManager.LayoutParams.WRAP_CONTENT, 1.0f));
                l.addView(button, new LinearLayout.LayoutParams(StaggeredGridLayoutManager.LayoutParams.WRAP_CONTENT, StaggeredGridLayoutManager.LayoutParams.WRAP_CONTENT, 0.0f));
...
//                            Keyboards.close(search);
                ...
                holder.links.addView(l, new LinearLayout.LayoutParams(StaggeredGridLayoutManager.LayoutParams.MATCH_PARENT, StaggeredGridLayoutManager.LayoutParams.WRAP_CONTENT));
                ...
                if (!link.href.equals(imgLink) && AppState.get().opdsLargeCovers) {
                    ...
                    holder.links.addView(img, new LinearLayout.LayoutParams(Dips.screenWidth() / 2, StaggeredGridLayoutManager.LayoutParams.WRAP_CONTENT));
                    imgLink = link.href;
                }
                ...
                if (downloadFormat != null) {
                    ...
                    android.widget.LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT);
