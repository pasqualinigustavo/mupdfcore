...
public class ImageDecodingInfo {
	...
	/** @return Original {@linkplain br.com.tocalivros.mupdfsample.universalimageloader.utils.MemoryCacheUtils#generateKey(String, ImageSize) image key} (used in memory cache). */
