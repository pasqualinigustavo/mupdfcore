...
import br.com.tocalivros.foobnix.pdf.search.activity.msg.MessageCenterHorizontally;
...
//    }
    ...
    @Override
    public void getOutline(br.com.tocalivros.foobnix.android.utils.ResultResponse<List<OutlineLinkWrapper>> outline, boolean forse) {
        if (codeDocument == null) {
            return;
        }
    ...
    @Override
    public void doSearch(final String text, final br.com.tocalivros.foobnix.android.utils.ResultResponse<Integer> result) {
