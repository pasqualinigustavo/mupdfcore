...
import br.com.tocalivros.foobnix.pdf.info.ExtFilter;
import br.com.tocalivros.foobnix.pdf.info.presentation.BrowserAdapter;
...
public class PrefDialogs {
    ...
    public static void selectFileDialog(final Context a, List<String> browseexts, File path, final br.com.tocalivros.foobnix.android.utils.ResultResponse<String> onChoose) {
