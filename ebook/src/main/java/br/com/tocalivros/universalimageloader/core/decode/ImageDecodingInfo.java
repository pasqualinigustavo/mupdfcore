...
import br.com.tocalivros.universalimageloader.core.DisplayImageOptions;
...
public class ImageDecodingInfo {
	...
	/** @return Original {@linkplain br.com.tocalivros.universalimageloader.utils.MemoryCacheUtils#generateKey(String, ImageSize) image key} (used in memory cache). */
